...
// büyük ise sağ tarafa
// kucuk ise sol tarafa

namespace DataStructures.Tree.BinaryTree
{
    public class BinaryTree<T> where T:IComparable // karsılastırılabilir comparable.
    {
        ...
        {
            if (!(root==null)) // kök nulla eşit değilse
            {
                InOrder(root.Left); // sola
                list.Add(root);     // ekle
                InOrder(root.Right);  // sağa
            }
            return list;
        }
